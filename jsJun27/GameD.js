...
class GameD extends Game{
	...
	init() {
		super.init(); console.log("GameD.init TOP  "  + singlePlayerMode )
		this.insertLayout();
	...
	regAns(sliderLoc) {// player lets up on the mouse ="onchange" = regAns
		...
		console.log("|||||regAns isFirstPlay= " + this.isFirstPlay + "  nowPlaying =" + cp.itf.nowPlaying + " singlePlayerMode= " + singlePlayerMode)//Done on mouseUp of sliderDay. Starts second play
