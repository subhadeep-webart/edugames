...
class PlayerLineUp{
	...
	setPlayerNames(playerInfo){console.log("SetPlayerNamesXX** " + playerInfo + " singlePlayerMode=  " + singlePlayerMode)//0;Peter;94566;10;5|1;Helen;94066;11;5
		const arr = playerInfo.split("|");
		bidButs.setBidTime(arr[0]);
		if (singlePlayerMode) {
			...
			secondPlayerBox.hidden = true;
			//const dummyPlayerInfo = "0;Dummy;94566;12;10  #00008B"//To get around having having a null player
			//const playerRight = new Player(dummyPlayerInfo, "#00008B", "SkyBlue", "#00008B","0");
	...
	clearRndScores(){//console.log("PlayerLineUp clearRndScores()top "  )
		if(this.players[0])this.players[0].clearRndScore();
		if(this.players[1])this.players[1].clearRndScore();
