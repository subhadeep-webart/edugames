...
class ControlPanel{            //          console.log(" = " + );
	...
	/*addHelpSelectionListener(){console.log("abp addSelectionListener top  " )
	...
	startGame(aRound,sampleData){console.log("^^^cp.startGame aRound = " + aRound.getGameType() + " onNet=  " + onNet);
