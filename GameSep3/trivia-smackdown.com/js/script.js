...
function check(){console.log("script.check  " + cp.theGameInPlay );
	cp.theGameInPlay.checkPlay();
}

function getHelp(txt){console.log("script.help  " + txt );
	const rnd = cp.theRoundInPlay;
	console.log("rnd  " + rnd );
	const xx = cp.help.getHelp(txt,rnd);
	console.log("xx  " + xx);
	if(confirm(xx)){
...
function runTheClock(){//console.log("script runTheClock  "  + seconds);
 ...
 function cleanPlayArea(){console.log("script.cleanPlayArea()" )
	  ...
	  const el = document.getElementById("timeBox");
...
function setUpTheDecreasingPtFacXX(startFac, inc, stopPt) {//used bu GameN deprecated
...
function adjustPtFacDownXX(plusMinus) {//used bu GameN deprecated
