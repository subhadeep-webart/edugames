...
//              }P.AA.Pi.Th.Tr.Na.SailBoat.KGDB.gif,{A-4red 009118038066 180,{A-4red 373118038066 180,{R-4red 004054057057,{W-4red 361055057057,
	...
	insrtCanvas(){
		...
		const canvasInsertPt = document.getElementById('imageInsertPt');
		...
		let theImage = new Image(imageArray[1],50,50,width,height);
	...
	createImage(context,path,x,y,w,h){
		...
		theImage.onload = function(){
			context.drawImage(theImage,x,t,w,h)
		}
	}
...
/*
	getImageSize(sizeCode){console.log("adjustImageSize = " +  sizeCode);
		//const orgSize = penAltPart.substring(0,2);
		let width = (sizeCode.charCodeAt(0) -64) * 32;
		let height = (sizeCode.charCodeAt(1) -64) * 32;
		console.log("width = " + width + " height= " + height);//192 128
