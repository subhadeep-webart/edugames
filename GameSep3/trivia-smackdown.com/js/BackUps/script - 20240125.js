...
function startGame(){//AA.Men00021
	...
	plu.registerPlayer("Pete,14,94566");
...
class ControlPanel{            //          console.log(" = " + );
	...
	startGame(aRound,sampleData){
		...
		switch (gameType) {
			case 'A':
				gameA = new GameA(aRound,this,this.utl);
				theGameInPlay = gameA;
				gameA.init();
			break;case 'B':
				gameB= new GameB(aRound,this,this.utl);
				theGameInPlay = gameB;
				gameB.init();
			break;
			case 'C':
				gameC = new GameC(aRound,this,this.utl);
				theGameInPlay = gameC;
				gameC.init();
			break;case 'D':
				gameD = new GameD(aRound,this,this.utl);
				theGameInPlay = gameD;
				gameD.init();
			break;;
			case 'E':
			...
			break;
			case 'N':
				gameN = new GameN(aRound,this,this.utl);
				theGameInPlay = gameN;
				gameN.init();
			break;
			case 'O':
...
class GameA extends Game{//console.log("GameA  = " + );
	...
	procSym(){console.log("procSym. "  + this.symArray)
		...
		//for(let i = 0;i <len;i++){console.log(i +  "  == " + this.symArray[i]);}
		let letterCount = 0
		...
		letterCount = 0
		for(let i = 0;i <len;i++){//{B-4lightGray 237138004080
...
class GameD extends GameN{//console.log("GameN  = " + );
	constructor (round,cp,utl){
