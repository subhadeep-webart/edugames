...
class BidButs {
    ...
    constructor(max,context) {
        ...
        this.init();
        this.bidWinnerNbr = 0;
        console.log("BB init (this.context == null) = " + (this.context == null));

    }

    stopBidClock() { console.log("bb stopBidClock() "  +  (this.context == null));
    ...
    makeBid(ltrNbr) {
        ...
        console.log("makBid " + ltrNbr + " remBut=  " + this.remButs + " this.context.mode.singlePlayer= "  + this.context.mode.singlePlayer);
        ...
        console.log("this.topBid=" + this.topBid + "   " + this.context.mode.singlePlayer)
        ...
        if (this.topBid == this.remButs || this.context.mode.singlePlayer) {//No need to continue with bidding
    ...
    procBid() {//this comes over from Script
        ...
        console.log(" GameContext.ui.bidButs procBid() top " + this.whoHasBid + " this.topBid=  " + this.topBid)
        ...
        console.log(" GameContext.ui.bidButs procBid() Bottom " + this.whoHasBid + " this.topBid=  " + this.topBid)
    ...
    runBidClock() {
        ...
        //console.log(" GameContext.ui.timeBox  GameContext.ui.bidButs runBidClock()  " + seconds + " this.whoHasBid=  " + this.whoHasBid + "   " + clockIsPause)
        ...
        //GameContext.ui.timeBox.value = sec + " Sec";

        GameContext.ui.timeBox.value = sec + " Sec";

        if (bidSeconds <= 0) {

            //this.GameContext.ui.timeBox.value = "Play In Progress"
    ...
    showAnsButXX() {
        ...
        GameContext.ui.ansBut.style.visibility = "visible";
    ...
    restartBidding() {
        ...
        console.log("resetBidButs Top() GameContext.ui.bidButs.remButs = " + GameContext.ui.bidButs.remButs + " cp.gameType " + cp.gameType );
        ...
        this.fillBoxes(this.remButs, cp.gameType, this.rows);//We reset to the new amount of buts
    ...
    createButs(butMax, gameType, rows) { 
        this.rows = rows;
        console.log("createButs" + butMax + " gameType= " + gameType +  " this.context.mode.singlePlayer "  + this.context.mode.singlePlayer);
        this.butMax = butMax;
        this.remButs = butMax;
        this.fillBoxes(butMax,cp.gameType,rows);
        let width = butMax * 32;
        width = 150;
    ...
    getTheTime(pNbr, gameType, nbrBut, rows) {
        ...
        console.log("|||Settings getTime pNbr= " + pNbr + "  gameType= " + gameType + " nbrBut=  " + nbrBut + " rows=  " + rows + "  cp.theGameInPlay.cols  " + cp.theGameInPlay.cols)

        let time = 0.0;

        const gameTypeFac = this.getGameTypeSpeedFac(gameType, cp.theGameInPlay.cols);
        ...
        //console.log("time=  " + time getGameTypeSpeedFac
