...
class Player{//#P
	...
	procPlayerInfo(playerInfo){//console.log("procPlayerInfo   "  +  " playerInfo=  " + playerInfo )
		...
		this.gradeLev = arr[3];
		this.speedLev = arr[4];
		GameContext.ui.bidButs.setPlayerSpeedFacs(this.nbr, this.speedLev);
		this.timeForGameLND = GameContext.ui.bidButs.getTimeForGameLND(this.speedLev);
	...
	addToSetScore(amt) {//console.log("P.addToSetScore  " + amt + "    " + this.name);
