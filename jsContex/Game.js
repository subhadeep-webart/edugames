...
class Game{
	constructor(round, context) {
		...
		console.log("AGame this.context == null)  " + (this.context == null));
		//this.cp = cp;
		////this.utl = utl;
		this.plu = plu;
		//this.itf = itf;
	...
	cleanPlayArea() {
		console.log("Game this.context == null)  " + (this.context == null));
		...
		////GameContext.ui.insrtPtB = document.getElementById("gameLInsrtPtB");
	}
	

	addAnswerToQuestionBar(ans) {
		console.log("Game addAnswerToQuestionBar " + ans);
		cp.itf.addToQuestion("--The Answer is  " + ans);

	}
    showAnswerInQuestionBar(ans) {
		console.log("Game showAnswerInQuestionBar " + ans);	

		cp.itf.setQuestion("the Question was :" + this.question + "--The Answer is  " + ans);
    }
