...
//http://edugames.com/cgi-bin/GetRounds.pl?AA.Cen00100
...
function getData(serNbr,type){ //AA.Qen00027
	...
	roundMap.set("AA.Cen00100",",AA.Cen00100,Ed-U-Games tm,20080324,10,ThSpTe ThOrSp,PhTe,,SpPr,professional sports team;sports;us sports team,}P.AA.Pi.Th.Sp.Ic.BaseballAndBat.FD.jpg }P.AA.Pi.Th.Sp.Ic.BasketballAndHoop.FD.jpg }P.AA.Pi.Th.Sp.Ic.Football.FD.jpg }P.AA.Pi.Th.Sp.Ic.Hockey.FD.jpg }P.AA.Pi.Th.Sp.Ic.Soccer.FD.jpg,aPRA1_410 zPRA1_30,,,,,Sports/US/Professional Teams,Place the US Professional Sports Team with the Sports Type.,,Rows=10 Cols=1 FntSize=12 FntColor=black BkGndColor=white BoxWidth=159 BoxHeight=27 CatRows=3 CatCols=2 CatFntSize=36 CatFntColor=magenta CatLabOpaque=No PanelBkGndColor=white Sort=Yes ,}P.AA.Pi.Th.Sp.Ic.BaseballAndBat.FDAB.jpg *Baseball;Marlins;Mets;,}P.AA.Pi.Th.Sp.Ic.BasketballAndHoop.FDBA.jpg *Basketball;Bucks;,}P.AA.Pi.Th.Sp.Ic.Football.FDcc.jpg *Football;Seahawks;Titans;,}P.AA.Pi.Th.Sp.Ic.Hockey.FD-E.jpg *Hockey;Maple Leafs;Red Wings;,}P.AA.Pi.Th.Sp.Ic.Soccer.FDB-.jpg *Soccer;Real;CD Chivas;Rapids;,,, ");
	...
	roundMap.set("AA.Aen00002",",AA.Aen-PRA1:0202145025m,Ed-U-Games tm,,8,,,,,,}P.AA.Pi.Th.Tr.Na.SailBoat.KG.gif,aPRA1_85 dPRA1_15,,,,,Boats/Terms,Which is the bow?,,Sort=Yes ,}P.AA.Pi.Th.Tr.Na.SailBoat.KG.gif,{A-4blue 016076038066 180,{A-4red 260076038066 180,{R-4red 026037028028,{W-4blue 264031028028");
	
	roundMap.set("AA.Xen00003",",AA.Xen00003,EdUGames tm,20021014,4,,,,,boats;sailboats;bow,}P.AA.Pi.Th.Tr.Na.SailBoat.KG.gif,aPRA1_80 dPRA1_15 zPRA1_15,,,PRA1;Boats/Sailboats/sailboat_terms.html,,Boats/Sailboats,Which is the Bow?,,Sort=Yes ,}P.AA.Pi.Th.Tr.Na.SailBoat.KG.gif,{A-4red 009118038066 180,{A-4red 373118038066 180,{R-4red 004054057057,{W-4red 361055057057,,,,,");
	...
	roundMap.set("AA.Aen00008",",AA.Aen00008,Ed-U-Games tm,,9.00,,,,,,}P.AA.Pi.Th.Tr.Na.SailBoat.KG.gif,aPRA1_245 dPRA1_15,,,,,xxx,xxx,,Sort=Yes ,}P.AA.Pi.Th.Tr.Na.SailBoat.KGDD.gif,{R-1red 015013010010,{W-1red 033013010010,{R-2red 078011014014,{W-2red 106012014014,{R-5red 352013036036,{W-5red 411012036036,{A-5red 395084045080 000,{A-1red 012035017024 000,{A-2red 088032024038 000,{A-4green 091080038038 315,{A-4green 089130058038 270,{A-4green 099178038038 225,{A-4green 148198038066 180,{C-4magenta 157008080080,{C-1magenta 012074020020,{D-5magenta 245010100100,{F-5orange 286134100100,{B-2lightGray 010113040040,{B-5lightGray 016251100005,{B-4lightGray 237138004080");
	...
	roundMap.set("AA.Qen00004",",AA.Qen00004,EdUGames tm,20020808,11,LoPoCo,GtheGameInPlayeNoUS,NoNoUS,GeAm,us;state,}B.AA.Bu.Ge.No.No.US.States.BL.csv,aPRA1_190 lPRA1_5 zPRA1_15,,,,,US/States,Answer these questions about the United States,Various Books on the subject.,Rows=6 Cols=1 FntSize=12 FntColor=black BkGndColor=white LnCnt=3 SingleScreen=No Sort=Yes,}B.AA.Bu.Ge.No.No.US.States.BL.csv,Topeka is a major urban areas in what state?;;Kansas,What state's highest point is Mt. McKinley at 20320 feet?;;Alaska,What state name is a Spanish name of an imaginary island?;;California,Moscow USA is in what state?;;Idaho,The Columbia is the border between what two states?;;Washington;Oregon,What state has the longest coastline?;;Alaska,What 4 states are named after kings?;;Georgia;Louisiana;North Carolina;South Carolina,What is the Golden State?;;California,What was the 48th state to join the Union?;;Arizona,The Yucca is the state flower and the Land of Enchantment is the nick name of what state?;;New Mexico,Haleakala National park is located in what state?;;Hawaii,The Badger State is the nick name of what state?;;Wisconsin,What state means -mountain region- in Latin?;;Montana,What state name is derived from the name of a president?;;Washington,Ft. Wayne is a major urban areas in what state?;;Indiana,Des Moines and Davenport are major urban areas in what state?;1;Iowa,The Baseball Hall of Fame is located in what state?;;New York,The Bluebonnet is the state flower of what state that starts with the letter T?;;Texas,What state name comes from French Royalty?;;Louisiana,,,,,,");
	roundMap.set("AA.Qen00003",",AA.Qen00003,EdUGames tm,20020807,11,ThMi,ScCh,,SiFa,science;elements,}B.AA.Bu.Th.Ba.El.PeriodicTblOfElements.BL.csv,aPRA1_130 lPRA1_5 zPRA1_15,,,,,Science/Chemistry,Answer these questions about the Elements.(Image Grid),,Rows=6 Cols=1 FntSize=9 FntColor=black BkGndColor=white LnCnt=4 SingleScreen=No Sort=Yes ,}B.AA.Bu.Th.Ba.El.PeriodicTblOfElements.BL.csv,What are the two elements in table salt?;^AA.DCL.A.46306;Sodium (Na);Chlorine (Cl),What is the major gas in air?;;Nitrogen (N),An isotope of this element is often used to date dead things:;;Carbon (C),A Single molecule of this element and oxygen forms a colorless-odorless gas that is often fatal to humans:;;Carbon (C),What element did Marie Curie discover?;;Radium (Ra),What is named after the person who developed the General Theories of Relativity?;;Einsteinium (Es),Water is composed of what two elements?;;Hydrogen (H);Oxygen (O),What element combines to form Helium in a fusion reaction?;;Hydrogen (H),What element doomed the Hindenburg?;;Hydrogen (H),What is the most abundant element in the Universe?;;Hydrogen (H),What element shares a name with the closest planet to the sun?;;Mercury (Hg),The Ozone Layer is composed of what element?;;Oxygen (O),The 235 isotope of this element is used in making energy:;;Uranium (U),,,,");
...
class ControlPanel{            //          console.log(" = " + );
	...
	setPoints(nbrOfPoints){
		this.pointTF.value = nbrOfPoints;
	}
	...
	startGame(aRound,sampleData){
		...
		switch (gameType) {
			case 'A':
				gameA = new GameA(aRound,this,this.utl,this.plu);
				theGameInPlay = gameA;
				gameA.init();
			break;
			case 'B':
				gameB= new GameB(aRound,this,this.utl,this.plu);
				theGameInPlay = gameB;
				gameB.init();
			break;
			case 'C':
				gameC = new GameC(aRound,this,this.utl,this.plu);
				theGameInPlay = gameC;
				gameC.init();
			break;
				case 'D':
				gameD = new GameD(aRound,this,this.utl,this.plu);
				theGameInPlay = gameD;
				gameD.init();
			break;
			case 'E':
				gameE = new GameE(aRound,this,this.utl,this.plu);
				gameE.init();
			break;
			case 'I':
				gameI = new GameI(aRound,this,this.utl,this.plu);
				gameI.init();
			break;
			case 'L':
				gameL = new GameL(aRound,this,this.utl,this.plu);
				gameL.init();
			break;
			case 'M':
				gameM = new GameM(aRound,this,this.utl,this.plu);
				gameM.init();
			break;
			case 'N':
				gameN = new GameN(aRound,this,this.utl,this.plu);
				theGameInPlay = gameN;
				gameN.init();
			break;
			case 'O':
				gameO = new GameO(aRound,this,this.utl,this.plu);
				gameO.init();
			break;
			case 'P':
				gameP = new GameP(aRound,this,this.utl,this.plu);
				gameP.init();
			break
			case 'Q':
				gameQ = new GameQ(aRound,this,this.utl,this.plu);
				gameQ.init();
			break;
			case 'U':
				gameU = new GameU(aRound,this,this.utl,this.plu);
				gameU.init();
			break;
			case 'X':
				gameX = new GameX(aRound,this,this.utl,this.plu);
				gameX.init();
			break;
...
class PlayerLineUp{
	...
	constructor (){
		this.players = [];
		//this.color = ["blue","red","green","purple"];//blue= BFC4FF, red =FF7B80 green= A9FFA9 purple = FF00FF
		this.color = ["blue","red","purple","green"];//blue= BFC4FF, red =FF7B80 green= A9FFA9 purple = FF00FF

		//this.altColor = ["SkyBlue","Salmon","Lime","Violet"]
	...
	init(){
		...
		this.colorMap.set("blue","SkyBlue");
		this.colorMap.set("red","Salmon");
		this.colorMap.set("green","Lime");
		this.colorMap.set("purple","Violet");
		*/
	}
	...
	getNextPlayer(){console.log("plu getNextPlayer= "+  "  this.pNbr=  " + this.pNbr);
		return this.players[this.pNbr++];//		console.log("  " + )
		if(this.pNbr == this.pMax){
			pNbr = 0;//We go around the loop
		}
	}
...
//&&&&
	...
	registerPlayer(info){		//console.log("plu.registerPlayer  " + info)
		const pArr = info.split(",");
...
class Player{//#P
	constructor (pArr){console.log(" new Player  " + pArr)
		this.name = pArr[0];
		this.gradeLev = pArr[1]
		this.zip = pArr[2];
		this.color = pArr[3];
		this.altColor = pArr[4];
		this.nbr =  pArr[5];
		this.score = 0.0;
		this.log = [];
	}
...
class Game{
	...
	init(){
		...
		this.breakOutRound();
		this.mapTheParms();
		this.insertTheQuestion();//playerName
...
class GameNX extends Game{//console.log("GameN  = " + );
	constructor (round,cp,utl){
	...
	init(){
		...
		super.init();
		this.setValues();
		this.insrtNumberLine();
		this.cp.plu.setFirstPlayerNbr(this.cp.firstPlayerNbr);
		this.setNextPlayer(); 
	}
	helloWorld(){
	...
	setUp(){
	const theSetUp =`
<table width="500px"><tr><td><input type="text" name="display" id="displayBox" value="1"></td></tr><tr width="500px"><td>                                                                      
...
<tr>                                                                 
<td><div width="500px" id='arrowInsrtPt'></div></td>
</tr>
<tr>
                                                                 
                                                                       
</tr><tr><td><div id="sliderDiv" height="24px">
<input width="500px" type="range" height="24px" onchange="gameN.regAns(this.value)"  oninput="gameN.setDisplay(this.value)" value="1" id="slider" min="1" max="100" />
</div></td></tr>
</table> 
	`
		const insertPtA = document.getElementById("insertPtA");

		insertPtA.innerHTML = insertPtA.innerHTML + theSetUp
	...
	setNextPlayer(){console.log("GameN setNextPlayer() = " + this.cp.plu.pMax );
		const player = this.cp.plu.getNextPlayer();
		if(player == null){
			this.evalAns();
			return;
		}
		console.log("GameN  = " + player.name + "  " + player.color);
		const tf = document.getElementById("playerName");
		tf.value = player.name;
		console.log("GameN.player.color "  + player.altColor)
		tf.style.backgroundColor = player.altColor;
		this.displayBox.style.backgroundColor = player.altColor;
		this.slider.style.backgroundColor = player.altColor;
	...
	placeArrows(){///Pi/Th/Sy/To/Ar/BlueUpArrow/BlueUpArrow.AA.jpg' id='undefined' />
		console.log("placeArrows()  " + this.cp.plu.pMax);//		    console.log( = "  + );
		var el = document.getElementById("slider");
		const slider = document.getElementById("slider");
		const parent = document.getElementById("sliderDiv");
		slider.parentNode.removeChild(slider);
		const arrowInsrtPt = document.getElementById("arrowInsrtPt");
		const xLoc = arrowInsrtPt.x;
		const yLoc = arrowInsrtPt.y
		console.log("arrowInsrtPt = "  + xLoc + "   " + yLoc);

//                                                   getImageFile("}P.AA.Pi.Th.Sy.Ta.NbrLine-1.PA.gif","nbrLine")
		for (let i = 0;i<this.cp.plu.pMax;i++){//
			const color = this.cp.plu.players[i].color;
			...
			const loc = this.sliderX[i]
		    console.log(i  + " sliderX[i]= "  + this.sliderX[i]);
			theArrow.style.left = (loc -10) +"px";

		}
            for (let i = 0;i<this.cp.plu.pMax;i++){ 
			    console.log(this.pAns[i] + " === "  + this.sliderX[i]);			
			}
	...
	insrtNumberLine(){//}P.AA.Pi.Th.Sy.Ta.NbrLine-1.PD.gif
		const img = getImageFile("}P.AA.Pi.Th.Sy.Ta.NbrLine-1.PA.gif|nbrLine")
		const insrtPt = document.getElementById("nbrLineInsrtPt");//Scale is 500 px wide
		insrtPt.innerHTML = insrtPt.innerHTML + img[0];
		const dropArea = document.getElementById("nbrLineInsrtPt");
		const display = document.getElementById("displayBox");
		//const arrowRunningArea = document.getElementById("arrowInsrtPt");
...
class GameC extends Game{//console.log(" =" + );
	...
	regCheckBut(){console.log("regCheckBut()")
	...
	startGame(game){
	  ...
	  const htmlInput = "<table border='1'  width='100%'><tr>><td width='30%'background-color='green'><div id='left'></div></td><td background-color='red'><div id='right'></div></td></tr</table>";
      ...
      let bufItems = ""
      for(let i = 0;i <mixedArray.length;i++){//background-color='#ffff00'
		const itemName=mixedArray[i]
		if(itemName.length > 0){
			bufItems += "<input type='button' id='" + itemName +"' class='draggableC' draggable='true' value='" + itemName + "'>\n";       
		}
	  } 
      const itemEL = document.getElementById("left");
      itemEL.innerHTML = itemEL.innerHTML + bufItems;   
   ...
   insrtImages(imageArray){
      ...
      for(let i = 0;i <imageArray.length;i++){
		...
		const imageFile = getImageFile(imageFilePath)
	...
	freezeAllItems(listOfAllPlacedItems){
		//console.log("listOfAllPlacedItems " +  listOfAllPlacedItems)     
	 ...
	 check(){
		...
		for(let i = 0;i <containers.length;i++){
			...
			if(el != null){
			  ...
			  if(arrayX.length > 1){
				...
				listOfAllPlacedItems+=  arrayX.slice(1) +  "," ;      
			  }
			}
	   }
   
	   for(let i = 0;i <catsWithItems.length;i++){
			   		  //console.log("||catsWithItems " + catsWithItems  )
		  const insrtPt = 	catsWithItems[i].shift();//we don't use this, but it is in the way, so we shift it'
		  const catName = catsWithItems[i].shift();
			   		  //console.log("||catName " + catName  )
		  const itemThatWereDroped =   catsWithItems[i]  //we shifted out the cat name
			   		  //console.log("||itemThatWereDroped " + itemThatWereDroped  )		  
		  const listOfItemsForThisCat =  this.catMap.get(catName) ;
			   		  //console.log("||catName " + catName  )
			 for(let k = 0;k <itemThatWereDroped.length;k++){
			   const  oneDropedItem = itemThatWereDroped[k];
			   		  //console.log("||oneDropedItem " + oneDropedItem  )
						//console.log("||listOfItemsForThisCat " + listOfItemsForThisCat  )
			   if(listOfItemsForThisCat.indexOf(oneDropedItem) == -1){
				  gotOneWrong  = true;
				  console.log("not ok= " +  oneDropedItem)
				  break;
			   }else{
				  console.log("ok= " +  oneDropedItem)
			   }
			 }
	   }
	   //console.log("|| listOfAllPlacedItems " +  listOfAllPlacedItems)  
	   if(gotOneWrong){
		 ...
		 console.log("Success "  )
		 this.freezeAllItems(listOfAllPlacedItems)
	   }      
	 }
...
class GameZ extends Game{//console.log("GameD  = " + );
	constructor (round,cp,utl){
	...
	init(){
		...
		this.procSym();
		//this.insrtImage();
		console.log("GameD.init BOTTOM "  +  this.gameInPlay);//  
	}

	helloWorld(){
	console.log("GameD.helloWorld" );//console.log("GameA  = " + );
		super.helloWorld();
	}
	getData(){ 
...
class GameI extends Game{
	...
	loadAlphaBar(){
		...
		const ansListPath=getImageFile(this.ansLstFile);
	...
	insertImage(){////   images/MtRushmore-1.PI.gif//this.imageFile                    //Replace with a file download onserver
		const imageFile = getImageFile(this.imageFile);  //'images/General-1.QJ.gif';
...
class GameL extends Game{
	...
	insertImage(){////   images/MtRushmore-1.PI.gif
		...
		const imagePathAndFile = getImageFile(this.mapFile);  //'images/General-1.QJ.gif';
...
//<img src="../../HTDocs/public_html/edugames.com/DataBase/A65AA65A/ResLibry/Pi/Pe/Le/Po/US/Pr/20PopPres/20PopPresRP.jpg" width="576" height="512" alt="" title="" />
	...
	addAnsImage(imageArray,nameArray){
		...
		const imagePaths = [];
		for (let i = 0;i < imageArray.length; i++){
			const ip = getImageFile(imageArray[i]);
			 imagePaths.push(ip);
		}
...
function alphaButHit(butLtr){
	   console.log(" alphaButHit "   + butLtr);//	           console.log("  "  );
...
function testB(){//    
	console.log("testB top  " );
	gameN.placeArrows();
	console.log("testB bottom  " );
...
function getImageSize(sizeCode){console.log("getImageSize = " +  sizeCode);
	//const orgSize = penAltPart.substring(0,2);
	let width = (sizeCode.charCodeAt(0) -64) * 32;
	let height = (sizeCode.charCodeAt(1) -64) * 32;
	console.log("width = " + width + " height= " + height);//192 128
	if(sizeCode.length > 2){
		const adjustingCodeWidth = sizeCode.charAt(2);//'Example -cc'
		...
		const adjustingCodeHeight = sizeCode.charAt(3);//'Example -cc'
...
function getImageFile(fileData,id,other){//@@@@
	...
	//let id = id;
	//let other = other;
	//[fileData,id,other]= data.split(",");
	
	//console.log("getImageFile top " + fileData);//}P.AA.Pi.Ge.No.No.Ma.General-1.QJAB.gif
    console.log("----------fileData = " + fileData);
    console.log("----------id = " + id)
	...
	const sizeCode = tempArray[tempArray.length -2];//QJAB
    //console.log("sizeCode = " + sizeCode);
	const orgSizeCode=  sizeCode.substring(0,2);//QJ
	tempArray[tempArray.length-2] = orgSizeCode;//The file does not have the adjustments

	const widthAndHeight = getImageSize(sizeCode);//get the width and height
	...
	const filePath = "../../HTDocs/public_html/edugames.com/DataBase/A65AA65A/ResLibry/" + buf;
...
str+= " />"
	...
	returnArray.push(height)
    console.log("g|-| returnArray = " + returnArray)

*/


function getImageFileXX(fileData,id){
	console.log("getImageFile" + fileData);//}P.AA.Pi.Ge.No.No.Ma.General-1.QJ.gif
