	...
	startGame(aRound,sampleData){
		...
		switch (gameType) {
			...
			case 'C':
				...
				gameC.init();
			break;case 'D':
				gameA = new GameD(aRound,this,this.utl);
				theGameInPlay = gameD;
				gameD.init();
			break;
			case 'M':
...
class GameN extends Game{//console.log("GameN  = " + );
	...
	init(){
		...
		this.setNextPlayer();		
		//this.setSliderEventHandler();//		console.log("  = " + )
		//this.procSym();
		//this.insrtImage();
		//console.log("GameN.init BOTTOM "  +  this.cp.plu.getInfo()  );//  
	}
	helloWorld(){
	...
	evalAns(){console.log("GameN evalAns()  "  );
		...
		let result = "The question was :" + this.question + " and "
		if(tCount  > 1){
...
//                                                            getImageFile("}P.AA.Pi.Th.Sy.Ta.NbrLine-1.PA.gif","nbrLine")
	...
	setValues(){//,Answer=500 Type=Integer LowBracket=200 HiBracket=1200,
		...
		const midNbr = (parseInt(this.hiNbr) - parseInt(this.loNbr));
...
class GameD extends Game{//console.log("GameD  = " + );
	constructor (round,cp,utl){
