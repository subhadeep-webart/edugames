...
function getImageFile(fileData,id){
...
//<img src="../../HTDocs/public_html/edugames.com/DataBase/A65AA65A/ResLibry/Pi/Th/Sy/To/Ar/BlueUpArrow/BlueUpArrow.AA.jpg" width="32" height="32" alt="" title="" />
	...
	insrtBlueArrow(){///Pi/Th/Sy/To/Ar/BlueUpArrow/BlueUpArrow.AA.jpg' id='undefined' />
		const img = getImageFile("}P.AA.Pi.Th.Sy.To.Ar.BlueUpArrow.AA.jpg","blueArrow")
	...
	insrtNumberLine(){//}P.AA.Pi.Th.Sy.Ta.NbrLine-1.PD.gif
		...
		const insrtPt = document.getElementById("nbrLineInsrtPt");
		insrtPt.innerHTML = insrtPt.innerHTML + img[0];
