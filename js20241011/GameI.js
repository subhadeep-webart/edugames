...
//Cols=8,}A.AA.An.Ge.No.No.US.CiStMo.AL.csv Iwo Jima-Memorial,
	...
	submitAns(){console.log("gameI submitAns " );
	...
	removeAPanel(){//console.log("removeAPanel " + this.butIdArr + " this.displayType  " + this.displayType);
		...
		if(this.typeSelection == "Author" && this.displayType != "BlockOut"){
			...
			//console.log("this.focusButHeight " + this.focusButHeight)
	...
	submitAns(){console.log("abp checkAnswer " +  this.abp.getMenuSelection());
	...
	addFocusButtons(){console.log("**************addFocusButtons"   );//
        ...
        console.log("GameI. addFocusButtons bottom"   );
	}

	positionFocusButtons(){console.log("positionFocusButtons= " + this.rows + "   " + this.cols );
		//const butWidth             = Math.round(this.imageWidth/this.cols);
		...
		console.log("this.focusButInc= " + this.focusButInc);
		...
		for(let i = 0;i< this.rows;i++){
			...
			//console.log(butID + " left " + xLoc )
			//console.log(butID + " top " + yLoc ) 
...
console.log("*******  ||    ************ this.imageWidth"  + this.imageWidth );//
	...
	cleanUpPlayAreaXX(){console.log("GameI cleanUpPlayArea  "  );//this.theAnsBar
		super.cleanPlayArea();
